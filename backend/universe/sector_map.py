...
SECTOR_OF: Dict[str, str] = {
    # NIFTY 50
    "ADANIENT": "METAL", "ADANIPORTS": "INFRA", "APOLLOHOSP": "HEALTHCARE",
    "ASIANPAINT": "FMCG", "AXISBANK": "PVT BANK", "BAJAJ-AUTO": "AUTO",
    "BAJFINANCE": "FIN SERVICE", "BAJAJFINSV": "FIN SERVICE", "BEL": "CAPITAL GOODS",
    "BHARTIARTL": "TELECOM", "BPCL": "OIL & GAS", "BRITANNIA": "FMCG",
    "CIPLA": "PHARMA", "COALINDIA": "POWER", "DRREDDY": "PHARMA",
    ...
    "MARUTI": "AUTO", "NESTLEIND": "FMCG", "NTPC": "POWER", "ONGC": "OIL & GAS",
    "POWERGRID": "POWER", "RELIANCE": "OIL & GAS", "SBILIFE": "FIN SERVICE",
    "SBIN": "PSU BANK", "SHRIRAMFIN": "FIN SERVICE", "SUNPHARMA": "PHARMA",
    "TATACONSUM": "FMCG", "TATAMOTORS": "AUTO", "TATASTEEL": "METAL",
    "TCS": "IT", "TECHM": "IT", "TITAN": "CONSUMER DURABLES", "TRENT": "RETAIL",
    "ULTRACEMCO": "CEMENT", "WIPRO": "IT",
    # NIFTY NEXT 50
    "ABB": "CAPITAL GOODS", "ADANIENSOL": "POWER", "ADANIGREEN": "POWER",
    "ADANIPOWER": "POWER", "AMBUJACEM": "CEMENT", "DMART": "RETAIL",
    ...
    "GAIL": "OIL & GAS", "GODREJCP": "FMCG", "HAVELLS": "CONSUMER DURABLES",
    "HAL": "CAPITAL GOODS", "ICICIGI": "FIN SERVICE", "ICICIPRULI": "FIN SERVICE",
    "IOC": "OIL & GAS", "INDIGO": "AVIATION", "IRFC": "FIN SERVICE",
    "JINDALSTEL": "METAL", "JIOFIN": "FIN SERVICE", "JSWENERGY": "POWER",
    ...
    "OFSS": "IT", "LTTS": "IT", "TATAELXSI": "IT", "PETRONET": "OIL & GAS",
    "SUZLON": "POWER", "IREDA": "POWER", "NHPC": "POWER", "SJVN": "POWER",
    "OIL": "OIL & GAS", "IGL": "OIL & GAS", "GUJGASLTD": "POWER", "NMDC": "METAL",
    ...
    "BLUESTARCO": "CONSUMER DURABLES", "KALYANKJIL": "CONSUMER DURABLES",
    ...
    "ETERNAL": "RETAIL", "FORCEMOT": "AUTO", "FORTIS": "HEALTHCARE",
    "GODFRYPHLP": "FMCG", "GVT&D": "CAPITAL GOODS", "HDFCAMC": "FIN SERVICE",
    "HINDPETRO": "OIL & GAS", "HYUNDAI": "AUTO", "IEX": "POWER",
    "INOXWIND": "POWER", "KAYNES": "CAPITAL GOODS", "KFINTECH": "FIN SERVICE",
    "LTF": "FIN SERVICE", "LTM": "IT", "MANAPPURAM": "FIN SERVICE",
    "MAXHEALTH": "HEALTHCARE", "MCX": "FIN SERVICE", "MOTILALOFS": "FIN SERVICE",
    "NAM-INDIA": "FIN SERVICE", "NBCC": "INFRA", "NYKAA": "RETAIL",
    "PGEL": "CONSUMER DURABLES", "PNBHOUSING": "FIN SERVICE",
    "POWERINDIA": "CAPITAL GOODS", "PREMIERENE": "POWER",
    "RADICO": "FMCG", "RVNL": "INFRA", "SAMMAANCAP": "FIN SERVICE",
    "SOLARINDS": "CHEMICALS", "SWIGGY": "RETAIL", "TMPV": "AUTO",
    "VMM": "RETAIL", "WAAREEENER": "POWER",
}
